...
```{r}
#extracting point data from csv files
homeless_shelters_coordinates <- data.frame(do.call("rbind", strsplit(as.character(homeless_shelters$geo_point_2d), ",", fixed = TRUE)))
```
