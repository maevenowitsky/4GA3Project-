...
After all variables were in one data frame and prepared for analysis, data was first visualized by creating choropleth maps for each variable of interest. 
...
```{r}
model_population <- lm(formula = access ~ population_2021, 
             data = census_data)
```
